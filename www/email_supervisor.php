...
$texto =$_POST['texto'];
  ...
  include ("Mail/mime.php");
   $recipients = 'supervisor@nctecbrasilcursos.com.br';
  # Cabeçalho do e-mail.
  $headers = 
    array (
      'From'    => 'supervisor@nctecbrasilcursos.com.br', # O 'From' é *OBRIGATÓRIO*.
      'To'      => $email,
      'Subject' => $ref
    );
 ...
 $html  .="<br><br><font color=blue>Telefone:&nbsp;&nbsp;</font>$tel";
 ...
 # Parâmetros para o SMTP. *OBRIGATÓRIO*
  $params = 
    array (
      ...
      'username' => 'supervisor=nctecbrasilcursos.com.br', # Usuário do SMTP
      'password' => 'nctec720' # Senha do seu MailBox.
    );
